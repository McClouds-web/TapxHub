    ...
    if (this.state.error) {
      return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-white p-8 text-center">
          <h1 className="text-[13px] font-black text-[#0F1E3D] mb-2">Something went wrong</h1>
          <p className="text-slate-500 text-[10px] mb-4 max-w-md">{(this.state.error as Error).message}</p>
          <button onClick={() => window.location.reload()} className="px-4 py-3 bg-[#0F1E3D] text-white rounded-xl text-[10px] font-bold uppercase tracking-widest">
            Reload
          </button>
        </div>
      );
