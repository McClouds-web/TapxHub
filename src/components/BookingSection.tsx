      ...
      <div className="mx-auto max-w-7xl relative z-10 w-full">
        ...
        <div className="flex flex-col items-center text-center mb-16 max-w-3xl mx-auto">
          ...
          <motion.p
            ...
            className="text-base text-[#0F1E3D]/60 leading-relaxed font-light max-w-2xl"
          >
            {calendarContext ||
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start w-full">
          ...
          <div className="lg:sticky lg:top-32 text-center lg:text-left flex flex-col items-center lg:items-start w-full">
            ...
            >
              ...
              <span className="text-[9px] md:text-[10px] font-black uppercase tracking-[0.35em] text-[#0F1E3D]/35">
                TapxMedia Hub
              </span>
            </motion.div>
          ...
          <div id="booking-calendar" className="w-full">
            ...
            >
              <div className="px-8 py-10 md:px-12 md:py-14 w-full">
                <AnimatePresence mode="wait">
                    ...
                    >
                      ...
                      {loadingSlots && (
                        <div className="flex items-center gap-2 mb-4 text-[#1E3A8A]">
                          ...
                          <span className="text-xs font-semibold">Checking availability…</span>
                        </div>
                      )}
                      ...
                      <Calendar
                        ...
                        classNames={{
                          ...
                          caption_label: "text-sm font-bold text-[#0F1E3D] uppercase tracking-wider",
                          ...
                          day: "w-full aspect-square flex items-center justify-center text-sm font-medium text-[#0F1E3D]/70 hover:bg-[#0F1E3D]/5 rounded-lg transition-colors cursor-pointer block",
                  ...
                  {step === "time" && (
                    ...
                    >
                      ...
                      <h4 className="text-base font-bold text-[#0F1E3D] flex items-center gap-2 mb-6">
                      ...
                      <div className="grid grid-cols-2 gap-3 w-full">
                        {slots.map((slot) => (
                           <button
                             ...
                             className="py-3 px-4 rounded-xl border border-[#0F1E3D]/10 text-sm font-bold text-[#0F1E3D]/60 hover:border-[#0F1E3D]/40 hover:bg-[#0F1E3D]/4 hover:text-[#0F1E3D] transition-all text-center"
                           >
                  ...
                  {step === "form" && (
                    ...
                    >
                      ...
                      {selectedSlot && date && (
                        <div className="flex items-center gap-2 mb-6 px-4 py-2.5 rounded-xl bg-[#0F1E3D]/4 border border-[#0F1E3D]/8">
                          <CalendarCheck className="w-3.5 h-3.5 text-[#1E3A8A] flex-shrink-0" />
                          <span className="text-xs font-bold text-[#0F1E3D]/70">
                      ...
                      <form onSubmit={handleSubmit} className="space-y-4 w-full">
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            className="w-full pl-9 pr-4 py-3 rounded-xl border border-[#0F1E3D]/10 text-sm font-medium text-[#0F1E3D] placeholder:text-[#0F1E3D]/30 focus:outline-none focus:border-[#0F1E3D]/30 focus:ring-2 focus:ring-[#0F1E3D]/8 transition-all bg-[#FAFAFA]"
                          />
                        </div>
                        ...
                        <div className="relative">
                          ...
                          <textarea
                            ...
                            onChange={handleFormChange}
                            rows={3}
                            className="w-full pl-9 pr-4 py-3 rounded-xl border border-[#0F1E3D]/10 text-sm font-medium text-[#0F1E3D] placeholder:text-[#0F1E3D]/30 focus:outline-none focus:border-[#0F1E3D]/30 focus:ring-2 focus:ring-[#0F1E3D]/8 transition-all bg-[#FAFAFA] resize-none"
                          />
                        </div>
                        ...
                        <Button
                          ...
                          className="w-full gap-2 rounded-xl h-12 text-xs font-black uppercase tracking-widest bg-[#0F1E3D] hover:bg-[#1E3A8A] shadow-md disabled:opacity-50 disabled:cursor-not-allowed transition-all"
                        >
                          {submitting ? (
                            <>
                        ...
                        <p className="text-center text-[9px] text-[#0F1E3D]/30 font-medium leading-relaxed">
                  ...
                  {step === "success" && (
                    ...
                    >
                      <div className="w-16 h-16 rounded-full bg-[#0F1E3D]/6 flex items-center justify-center mb-6">
                      ...
                      <h3 className="text-2xl md:text-3xl font-bold text-[#0F1E3D] mb-4 leading-tight">
                        Your Strategy Call <br />is Booked!
                      </h3>

                      <p className="text-sm text-[#0F1E3D]/55 font-light leading-relaxed mb-2 max-w-xs">
                        A calendar invite and confirmation email is on its way to{" "}
                        <span className="font-semibold text-[#0F1E3D]/80">{form.email}</span>.
                      </p>

                      {selectedSlot && date && (
                        <div className="flex items-center justify-center gap-2 mt-4 mb-8 px-5 py-3 rounded-xl bg-[#0F1E3D]/4 border border-[#0F1E3D]/8">
