...
function DevRoleSwitcherInner() {
  ...
  return (
    <button
      onClick={switchRole}
      className="fixed bottom-4 right-4 z-[999] text-[9px] font-black uppercase tracking-widest px-3 py-1.5 rounded-lg bg-white/80 border border-[#0F1E3D]/15 text-[#0F1E3D]/50 shadow-sm hover:bg-white hover:text-[#0F1E3D] hover:border-[#0F1E3D]/25 transition-all backdrop-blur-sm"
