            ...
            <AnimatePresence>
                {isChatOpen && (
                    <motion.div
                        ...
                        className="fixed bottom-20 md:bottom-28 right-4 md:right-8 z-[110] w-[calc(100vw-2rem)] md:w-[380px] h-[580px] max-h-[70vh] bg-white border border-[#0F1E3D]/10 rounded-xl shadow-[0_20px_60px_-15px_rgba(15,30,61,0.2)] flex flex-col overflow-hidden"
                    >
                        {/* Header */}
                        <div className="flex items-center justify-between p-3 border-b border-[#0F1E3D]/5 bg-[#F8FAFC] shrink-0">
                            <div className="flex items-center gap-3">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <div className="flex items-center gap-1.5 mt-0.5">
                                        ...
                                        <p className="text-[10px] text-[#0F1E3D]/40 font-black uppercase tracking-widest">Neural Link Active</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div 
                            ref={messagesEndRef}
                            className="flex-1 p-3 overflow-y-auto flex flex-col gap-5 bg-white scrollbar-thin scrollbar-thumb-[#0F1E3D]/10 scrollbar-track-transparent"
                        >
                            {messages.map((msg) => (
                                <div key={msg.id} className={cn("text-[10px] p-3 rounded-xl shadow-sm leading-relaxed max-w-[90%]", msg.sender === 'bot' 
                            ...
                            {isTyping && (
                                <div className="self-start bg-[#F8FAFC] border border-[#0F1E3D]/5 p-3 rounded-xl rounded-tl-sm">
                        ...
                        {/* Input Area */}
                        <form onSubmit={handleSendMessage} className="p-3 bg-[#F8FAFC] border-t border-[#0F1E3D]/5 shrink-0">
                            <div className="relative flex items-center group">
                                <input
                                    ...
                                    disabled={isTyping}
                                    className="w-full bg-white border border-[#0F1E3D]/10 rounded-xl py-3.5 pl-4 pr-12 text-[10px] text-[#0F1E3D] placeholder-[#0F1E3D]/20 focus:outline-none focus:border-[#0F1E3D]/30 focus:ring-4 focus:ring-[#0F1E3D]/5 transition-all disabled:opacity-50"
                                />
                                <button
                                    type="submit"
