  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between mb-4 shrink-0">
        <h3 className="text-[11px] font-bold text-[var(--text-primary)] flex items-center gap-2">
            ...
            return (
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  <p className="text-[10px] font-medium leading-snug" style={{ color: "var(--text-primary)" }}>
                    {activity.text}
                  </p>
