    ...
    >
      ...
      <div className="mb-4 flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-3 py-1.5 text-[10px] font-medium text-[var(--text-secondary)] hover:text-[var(--text-primary)] hover:border-[var(--border-hover)]"
        >
      ...
      <div className="space-y-2">
        {upcoming.map((item, i) => (
          ...
          >
            {/* Date */}
            <span className="w-12 text-[10px] font-semibold text-[var(--text-secondary)] shrink-0">
        ...
        {upcoming.length === 0 && (
          <p className="text-[10px] text-[var(--text-secondary)] py-4 text-center">
            No upcoming events.
          </p>
        )}
      </div>
