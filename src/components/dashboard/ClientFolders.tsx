...
function SkeletonCard() {
  return (
    <div className="animate-pulse p-4 rounded-[var(--radius)]"
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-2">
        <div>
          <h3 className="text-lg font-semibold text-[var(--text-primary)]">Client Folders</h3>
          <p className="text-xs text-[var(--text-secondary)] mt-0.5">Quick access to all clients</p>
        </div>
        <button style={{
        ...
        {isLoading ? (
          ...
          companies.map((company, i) => {
            ...
            return (
              ...
              >
                <div className="h-10 w-10 rounded-full flex items-center justify-center shrink-0 text-white text-lg font-bold"
