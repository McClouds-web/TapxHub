...
function TodayProgressRing() {
  ...
  return (
    <div className="relative z-10 mt-4 md:mt-0 flex flex-col items-center justify-center shrink-0 md:ml-8 lg:mr-4 p-3 bg-white/50 rounded-xl border border-white shadow-sm">
      <div className="relative w-24 h-24 flex items-center justify-center rounded-full bg-[#f8fafc] shadow-inner">
        ...
        <span className="text-[13px] font-black text-[var(--brand-primary)]">{pct}%</span>
      </div>
      <span className="text-[10px] font-bold text-[var(--brand-primary)] opacity-60 mt-3 tracking-[0.2em] uppercase">
        Today's Progress
      </span>
    </div>
  );
...
export function MorningBriefing() {
  ...
  return (
    <motion.div
      className="relative overflow-hidden rounded-[var(--radius-xl)] p-3 sm:px-6 sm:py-4 flex flex-col md:flex-row items-center justify-between group"
      style={{
    ...
    >
      <div className="relative z-10 flex-1">
        ...
        <div className="flex flex-wrap items-center gap-3">
          <Link
            to="/planner"
            className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-wider bg-white/70 px-3 py-1.5 rounded-lg border border-[#0F1E3D]/5 text-[var(--brand-primary)] shadow-sm hover:scale-105 transition-transform outline-none"
          >
