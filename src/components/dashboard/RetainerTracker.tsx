  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-2">
        <div>
          <h3 className="text-[11px] font-semibold text-[var(--text-primary)]">Retainer Clients</h3>
          <p className="text-[10px] text-[var(--text-secondary)] mt-0.5">Monthly work tracker</p>
        </div>
        <button style={{
            ...
            return (
              ...
              >
                <div className="flex items-start justify-between mb-3">
                  <h4 className="text-[10px] font-bold text-[var(--text-primary)]">{client.name}</h4>
                  <span className="text-[10px] font-bold px-2 py-0.5 rounded-full"
                    style={{ background: "rgba(168,85,247,0.1)", color: "#a855f7" }}>
                    Retainer
                  </span>
                </div>
                <p className="text-[13px] font-bold mb-1" style={{ color: "var(--brand-accent)" }}>
                  P{Number(client.monthly_amount).toLocaleString()}
                  <span className="text-[10px] font-normal text-[var(--text-secondary)] ml-1">/mo</span>
                </p>
                <p className="text-[10px] text-[var(--text-secondary)] mb-3">{currentMonth}</p>
                ...
                <div className="flex gap-2">
                  ...
                  }} className="flex-1 py-1.5 text-[10px] font-medium hover:text-[var(--text-primary)]">
                    Log Work
                  </button>
                  <button
                    ...
                    className="flex-1 py-1.5 text-[10px] font-semibold text-white hover:opacity-90"
                  >
                    Mark Complete
                  </button>
                </div>
