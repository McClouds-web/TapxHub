  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-5 shrink-0 px-1">
        <div>
          <h3 className="text-xl font-extrabold text-[var(--brand-primary)] tracking-tight">Financial Overview</h3>
          ...
          return (
            ...
            >
              ...
              <div className="flex flex-col items-end justify-center w-1/4 sm:w-1/3 min-w-0 pl-2">
                ...
                <span className="text-[9px] font-bold text-[var(--brand-primary)]/30 mt-1.5 uppercase tracking-widest hidden sm:block">vs Last Year</span>
              </div>
            </motion.div>
          );
        })}
