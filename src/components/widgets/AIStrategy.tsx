    ...
    <div className="flex flex-col gap-5 h-full">
      <div className="glass-card p-6">
        <div className="flex items-center justify-between mb-8">
           <div>
              <h3 className="text-sm font-black uppercase tracking-widest text-[#0F1E3D]">AI Cognitive Layer</h3>
        ...
        <div className="space-y-6">
           ...
           <div className="p-5 bg-indigo-500/5 border border-indigo-500/10 rounded-2xl relative overflow-hidden group">
              ...
              <div className="flex items-center gap-3 mb-4">
                 ...
                 <div>
                    <h4 className="text-xs font-black uppercase tracking-widest text-[#0F1E3D]">Agent Smith (Content)</h4>
                    <p className="text-[9px] font-bold text-indigo-600 uppercase">Processing: Social Sprint #14</p>
                 </div>
              </div>
           ...
           <div className="grid grid-cols-2 gap-4">
              <div className="p-4 bg-white border border-[#0F1E3D]/5 rounded-xl">
                 <Cpu className="w-4 h-4 text-[#0F1E3D]/30 mb-2" />
                 <span className="text-[9px] font-black uppercase text-[#0F1E3D]/40 block">Systems Integrated</span>
                 <span className="text-sm font-black text-[#0F1E3D]">12/13 OS Pillars</span>
              </div>
              <div className="p-4 bg-white border border-[#0F1E3D]/5 rounded-xl">
                 <MessageSquare className="w-4 h-4 text-[#0F1E3D]/30 mb-2" />
                 <span className="text-[9px] font-black uppercase text-[#0F1E3D]/40 block">Daily Inferences</span>
                 <span className="text-sm font-black text-[#0F1E3D]">4,210 Ops</span>
              </div>
           </div>

           {/* AI Roadmap Note */}
           <div className="p-4 bg-[#F8FAFC] rounded-xl border border-dashed border-[#0F1E3D]/10">
