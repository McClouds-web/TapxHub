    ...
    <div className="flex flex-col gap-5 h-full">
      <div className="glass-card p-6 flex flex-col gap-6">
        <div className="flex items-center justify-between">
           <div>
              <h3 className="text-sm font-black uppercase tracking-widest text-[#0F1E3D]">Data Intelligence</h3>
        ...
        <div className="grid grid-cols-2 gap-4">
           {[
             ...
             <div key={i} className="p-4 bg-[#F8FAFC] border border-[#0F1E3D]/5 rounded-xl flex items-center gap-3">
                ...
                <div>
                   <span className="text-[8px] font-black uppercase text-[#0F1E3D]/30 block">{item.label}</span>
                   <span className="text-xs font-black text-[#0F1E3D]">{item.val}</span>
                </div>
             </div>
           ))}
        </div>
