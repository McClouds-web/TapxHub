  ...
  return (
    <div className="glass-card p-3 h-full flex flex-col">
      <div className="flex items-center justify-between mb-4">
        <div>
          <h3 className="text-[10px] font-black uppercase tracking-widest text-[#0F1E3D]">Asset Review</h3>
          <p className="text-[10px] text-[#0F1E3D]/40 font-bold uppercase tracking-widest mt-1">Video Creative Gallery</p>
        </div>
        <div className="flex items-center gap-1.5 bg-indigo-500/10 text-indigo-600 px-2 py-0.5 rounded-full text-[10px] font-black uppercase tracking-widest">
          3 Pending
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto pr-1 space-y-4">
        {MOCK_REVISIONS.map((asset) => (
          <div key={asset.id} className="group relative rounded-xl overflow-hidden border border-[#0F1E3D]/5 bg-[#F8FAFC] hover:shadow-lg hover:shadow-indigo-500/5 transition-all">
            <div className="aspect-video w-full relative">
              ...
              <div className="absolute top-3 left-3 bg-[#0F1E3D]/80 backdrop-blur-sm text-white text-[10px] font-black px-2 py-0.5 rounded-md uppercase tracking-widest">
                v{asset.version}
              </div>
            </div>
            <div className="p-3 flex items-center justify-between">
              <div>
                ...
                <span className="text-[10px] font-bold text-[#0F1E3D]/40 uppercase tracking-widest">{asset.date}</span>
              </div>
      ...
      <button className="w-full mt-4 py-3 bg-[#0F1E3D] text-white rounded-xl text-[10px] font-black uppercase tracking-[0.2em] shadow-lg shadow-[#0F1E3D]/10 hover:shadow-xl hover:scale-[1.02] transition-all">
        Upload New Creative
      </button>
    </div>
  );
