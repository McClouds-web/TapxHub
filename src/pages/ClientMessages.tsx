  ...
  return (
    <motion.div variants={container} initial="hidden" animate="show"
      ...
      <motion.div variants={item} className="flex gap-5 flex-1 min-h-0">
        {/* Left panel */}
        <div className="w-[280px] shrink-0 flex flex-col bg-white border border-[#0F1E3D]/5 rounded-2xl shadow-sm overflow-hidden">
          ...
          {!selectedId ? (
            ...
            <>
              ...
              <div className="px-6 py-4 border-b border-[#0F1E3D]/5 bg-[#F8FAFC]/50 shrink-0 flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-extrabold text-[var(--brand-primary)]">TapxMedia Agency</p>
                  {selected?.subject && (
              ...
              <div className="flex-1 overflow-y-auto px-6 py-4 space-y-3">
                {loadingMsgs ? (
                  ...
                  <div className="h-full flex flex-col items-center justify-center text-center">
                    ...
                    <p className="text-xs font-bold text-[var(--brand-primary)]/40">
