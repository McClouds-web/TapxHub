        ...
        <div className="flex min-h-screen items-center justify-center bg-white p-4">
            ...
            >
                <div className="mb-0 flex flex-col items-center text-center">
                    <div className="mb-8 flex items-center justify-center p-4 bg-white rounded-3xl shadow-sm border border-[#0F1E3D]/5">
                        <img src={`${import.meta.env.BASE_URL}logo.png`} alt="TapxMedia" className="h-[40px] w-auto object-contain" />
                    </div>
                    <h1 className="text-4xl font-black tracking-tighter text-[#0F1E3D] uppercase flex items-center gap-2">
                        Hub <span className="text-[#1E3A8A] italic">OS</span>
                    </h1>
                    <p className="mt-4 text-[#0F1E3D]/40 text-xs font-black uppercase tracking-[0.2em]">
                        Agency Operating System
                    </p>
                </div>

                <div className="mt-8 flex w-full max-w-md bg-[#F8FAFC] p-1 rounded-2xl border border-[#0F1E3D]/5 mb-4 shadow-inner">
                    <button
                        type="button"
                ...
                <Card className="border-[#0F1E3D]/5 bg-white/90 shadow-2xl shadow-[#0F1E3D]/5 backdrop-blur-xl rounded-[2rem] overflow-hidden mt-6 flex flex-col items-center">
                    <CardHeader className="space-y-1 pb-6 w-full bg-[#F8FAFC]/50 border-b border-[#0F1E3D]/5">
                        <CardTitle className="text-lg font-extrabold text-[#0F1E3D] flex items-center gap-2">
                    ...
                    <CardContent className="pt-8 w-full p-6">
                            <motion.form 
                                key="auth-form"
                            ...
                            >
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="relative">
                                            ...
                                            <Input
                                                ...
                                                className="pl-11 h-12 rounded-xl border-[#0F1E3D]/10 bg-[#F8FAFC] focus-visible:ring-[#1E3A8A] font-bold tracking-widest text-center text-lg placeholder:text-[#0F1E3D]/20 placeholder:tracking-normal"
                                                maxLength={8}
                                            />
                                        </div>
                                    </div>
                                ...
                                <Button
                                    type="submit"
                                    disabled={isLoading}
                                    className="w-full h-14 bg-[#0F1E3D] hover:bg-[#1E3A8A] text-white text-xs font-black uppercase tracking-[0.2em] rounded-2xl shadow-xl shadow-[#0F1E3D]/10 transition-all hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50 mt-4"
                                >
                                    {isLoading ? (
                ...
                <p className="mt-8 text-center text-[10px] font-black uppercase tracking-widest text-[#0F1E3D]/20 leading-loose">
