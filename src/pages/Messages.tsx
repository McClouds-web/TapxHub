  ...
  return (
    <motion.div variants={container} initial="hidden" animate="show"
      ...
      <motion.div variants={item} className="flex gap-5 flex-1 min-h-0">
        ...
        <div className="w-[300px] shrink-0 flex flex-col bg-white border border-[#0F1E3D]/5 rounded-xl shadow-sm overflow-hidden">
          <div className="px-4 py-4 border-b border-[#0F1E3D]/5 shrink-0">
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-[#F8FAFC] border border-[#0F1E3D]/10 rounded-xl pl-9 pr-3 py-2 text-[10px] font-bold text-[var(--brand-primary)] placeholder:text-[#0F1E3D]/30 focus:outline-none focus:border-[#1E3A8A]/30 transition-colors"
              />
            </div>
          </div>
          ...
          <div className="flex-1 overflow-y-auto">
            {loadingConvs ? (
              ...
              <div className="flex-1 flex flex-col items-center justify-center p-3 text-center h-full">
        ...
        <div className="flex-1 flex flex-col bg-white border border-[#0F1E3D]/5 rounded-xl shadow-sm overflow-hidden">
          {!selectedId ? (
            <div className="flex-1 flex flex-col items-center justify-center p-8 text-center">
              <div className="w-16 h-16 rounded-xl bg-[#F8FAFC] border border-[#0F1E3D]/5 flex items-center justify-center mb-4 shadow-sm">
            ...
            <>
              ...
              <div className="px-4 py-4 border-b border-[#0F1E3D]/5 bg-[#F8FAFC]/50 shrink-0 flex items-center gap-3">
                ...
                <div>
                  <p className="text-[10px] font-extrabold text-[var(--brand-primary)]">{selected?.company_name}</p>
                  {selected?.subject && (
              ...
              <div className="flex-1 overflow-y-auto px-4 py-4 space-y-3">
                {loadingMsgs ? (
                  ...
                  <div className="flex-1 flex flex-col items-center justify-center h-full text-center">
                    ...
                    <p className="text-[10px] font-bold text-[var(--brand-primary)]/40">No messages yet. Say hello!</p>
                  </div>
                ) : (
                  messages.map((msg, i) => {
      ...
      <AnimatePresence>
        {showNewConv && (
          ...
          >
            ...
            >
              <h2 className="text-[12px] font-extrabold text-[var(--brand-primary)] mb-1">New Conversation</h2>
              <p className="text-[10px] font-bold uppercase tracking-widest text-[var(--brand-primary)]/40 mb-4">
              ...
              <div className="flex gap-3 mt-5">
                ...
                <button
                  ...
                  className="flex-1 px-4 py-3 bg-[#0F1E3D] text-white rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-[#1E3A8A] transition-all shadow-md disabled:opacity-50"
                >
