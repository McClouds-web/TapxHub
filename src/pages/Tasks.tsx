        ...
        <div className="flex items-center gap-2 mr-2 bg-white/20 p-1 rounded-full backdrop-blur-sm border border-white/40">
          {(["all", "todo", "in_progress", "done"] as const).map((f) => (
            <button
              ...
              onClick={() => setFilter(f)}
              className={cn(
                "rounded-full px-4 py-2 text-[10px] font-bold transition-all duration-300",
                filter === f
          ...
          {filteredTasks.map((task: any) => {
            ...
            return (
              <motion.div
                ...
                className={cn(
                  "glass-card flex flex-col md:flex-row md:items-center gap-4 p-3 transition-all group",
              ...
              >
                <div className="flex items-center gap-4 flex-1">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className={cn(
                      "text-[10px] font-bold text-foreground transition-all group-hover:text-accent",
